        ...
        <div class="content">
            <form method="POST">
                <div class="form-group">
                    <input class='input' type="number" name="otp" id="txtotp" placeholder = "Enter the otp....">
                </div><br>
                <div class="otpbtn">
                    <input class='input' type="submit" id="btnotp" name="Verify" value="Verify">
                </div>
                <div class="reotpbtn">
                    <input class='input' type="submit" id="btnreotp" name="resendotp"  value="Resend OTP">
                </div>
            </form> 
        </div>
    </center>
