...
<div >
  ...
  <table class="table ">
    ...
    <?php
      ...
      $sql="SELECT tbl_productinfo.Id , tbl_productinfo.Image , tbl_productinfo.Product_name , tbl_productinfo.Description, tbl_category.Name, tbl_productinfo.Pirce   from tbl_productinfo, tbl_category WHERE tbl_productinfo.Category_Id=tbl_category.Category_Id";
