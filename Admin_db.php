    ...
    <div id="main-content" class="container allContent-section py-4">
        <div class="row">
            ...
            <div class="col-sm-3">
                <div class="card">
                    <i class="fa fa-list mb-2" style="font-size: 70px;"></i>
                    <h4 style="color:white;">Total Employee</h4>
                    <h5 style="color:white;">
                    <?php
                       
                       $sql="SELECT * from tbl_dilivery_person";
                       $result=$conn-> query($sql);
                       $count=0;
                       if ($result-> num_rows > 0){
                           while ($row=$result-> fetch_assoc()) {
        ...
        <?php
            ...
            if (isset($_GET['Employee']) && $_GET['Employee'] == "success") {
                echo '<script> alert("Employee Successfully Added")</script>';
            }else if (isset($_GET['Employee']) && $_GET['Employee'] == "error") {
                echo '<script> alert("Adding Unsuccess")</script>';
            }
