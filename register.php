    ...
    <head>
        ...
        <style>
            * {
            ...
            /* Center the form content and make form elements stacked */
            form {
                display: flex;
        ...
        <div class="content">
            ...
            <form method="post" action="">
                ...
                <div class="form-group">
                    ...
                    <input class='input'type="text" id="name" name="name" pattern="[A-Z or a-z]{2,}" placeholder="Name" class="box" required>
                ...
                <div class="form-group">
                    ...
                    <input class='input' type="password" id="passkey1" name="passkey" pattern="{8,}" placeholder="Password" class="box" required>
                </div>

                <div class="form-group">
                    <label for="passkey2">Confirm Password :</label>
                    <input class='input' type="password" id="passkey2" name="passkey-c" pattern="{8,}" placeholder="Confirm Password" class="box" required>
                </div>
